...
function evaluateWeightForHeight(gender, height, weight) {
    ...
    const criteriaData = {
        ...
        male: [
            ...
            {h: 115, s: [16.5, 17.5, 23.5, 25.5, 31.0]},
            {h: 120, s: [18.0, 19.0, 25.5, 28.0, 34.0]},
            {h: 125, s: [19.5, 20.8, 27.8, 30.5, 37.5]},
            {h: 130, s: [21.2, 22.5, 30.5, 33.5, 41.5]},
            {h: 135, s: [23.2, 24.8, 33.5, 37.0, 46.0]},
            {h: 140, s: [25.5, 27.2, 37.5, 41.5, 51.5]}
        ]
    };
