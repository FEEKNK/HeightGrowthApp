...
function evaluateWeightForHeight(gender, height, weight) {
    ...
    const criteriaData = {
        female: [
            ...
            {h: 115, s: [16.0, 17.2, 22.8, 25.0, 30.5]},
            {h: 120, s: [18.2, 19.5, 25.5, 28.0, 34.5]},
            {h: 125, s: [20.5, 22.0, 29.0, 32.0, 39.5]},
            {h: 130, s: [22.8, 24.5, 33.5, 36.8, 45.0]},
            {h: 135, s: [25.0, 27.0, 37.5, 41.5, 51.0]},
            {h: 140, s: [27.5, 30.0, 42.0, 46.5, 57.0]}
        ],
        male: [
