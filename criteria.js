...
function evaluateWeightForHeight(gender, height, weight) {
    ...
    const criteriaData = {
        female: [
            ...
            {h: 90,  s: [10.5, 11.0, 14.5, 15.8, 18.5]},
            {h: 95,  s: [11.5, 12.2, 16.2, 17.5, 20.5]},
            {h: 100, s: [12.5, 13.5, 18.0, 19.5, 23.0]},
            {h: 105, s: [13.8, 14.5, 19.5, 21.2, 25.2]},
            {h: 110, s: [15.0, 16.0, 21.0, 23.0, 27.8]},
            {h: 115, s: [16.2, 17.5, 23.2, 25.2, 31.0]},
            {h: 120, s: [18.0, 19.2, 25.8, 28.0, 34.2]},
            {h: 125, s: [20.0, 21.5, 28.8, 31.2, 38.0]},
            {h: 130, s: [22.0, 23.8, 32.0, 35.0, 42.5]},
            {h: 135, s: [24.5, 26.2, 36.0, 39.2, 47.8]},
            {h: 140, s: [27.0, 29.2, 40.5, 44.2, 54.0]}
        ],
        male: [
