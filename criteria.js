...
function evaluateWeightForHeight(gender, height, weight) {
    ...
    const criteriaData = {
        female: [
            {h: 85,  s: [9.2,  10.0, 13.0, 14.0, 16.0]},
            {h: 90,  s: [10.5, 11.2, 14.5, 15.8, 18.5]},
            {h: 95,  s: [11.5, 12.5, 16.2, 17.5, 20.5]},
            {h: 100, s: [12.8, 13.8, 17.8, 19.5, 23.0]},
            {h: 105, s: [13.8, 14.8, 19.0, 21.0, 25.0]},
            {h: 110, s: [14.8, 15.8, 20.5, 22.5, 27.0]},
            {h: 115, s: [15.8, 16.8, 22.5, 24.5, 29.5]},
            {h: 120, s: [17.0, 18.2, 24.5, 26.5, 32.5]},
            {h: 125, s: [18.5, 19.8, 26.5, 29.0, 35.5]},
            {h: 130, s: [20.0, 21.2, 29.5, 32.0, 39.0]},
            {h: 135, s: [21.2, 22.8, 32.5, 35.5, 43.5]},
            {h: 140, s: [22.5, 24.2, 36.0, 39.5, 48.5]}
        ],
        male: [
            {h: 85,  s: [9.5,  10.5, 13.5, 14.5, 16.5]},
            {h: 90,  s: [11.0, 11.5, 15.0, 16.5, 19.0]},
            {h: 95,  s: [12.0, 13.0, 17.0, 18.5, 21.5]},
            {h: 100, s: [13.0, 14.0, 18.5, 20.0, 24.0]},
            {h: 105, s: [14.0, 15.0, 19.5, 21.5, 26.0]},
            {h: 110, s: [15.0, 16.0, 21.0, 23.0, 28.0]},
            {h: 115, s: [16.0, 17.0, 23.0, 25.0, 30.0]},
            {h: 120, s: [17.5, 18.5, 25.0, 27.0, 33.0]},
            {h: 125, s: [19.0, 20.0, 27.0, 29.5, 36.0]},
            {h: 130, s: [20.5, 21.5, 30.0, 32.5, 39.5]},
            {h: 135, s: [21.5, 23.0, 33.0, 36.0, 44.0]},
            {h: 140, s: [23.0, 24.5, 36.5, 40.0, 49.0]}
        ]
    };
